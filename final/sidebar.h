...
//the sidebar really should have a mini map, but we didn't have time
//and weren't comfortable in drastically altering the draw method of opengl.cpp
//I don't think it would be too dificult, but we wanted to get the game working first
